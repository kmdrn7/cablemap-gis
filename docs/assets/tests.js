...
define('cablemap-gis/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/company-logos.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/company-logos.js should pass ESLint\n\n3:8 - \'$\' is defined but never used. (no-unused-vars)');
  });

  QUnit.test('components/link-to-landing-point.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/link-to-landing-point.js should pass ESLint\n\n');
  });

  QUnit.test('components/map-container.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/map-container.js should pass ESLint\n\n');
  });

  QUnit.test('helpers/rfs-link.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/rfs-link.js should pass ESLint\n\n');
  });

  QUnit.test('initializers/setup-map.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'initializers/setup-map.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/landing-point.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/landing-point.js should pass ESLint\n\n');
  });

  QUnit.test('routes/ready-for-service.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/ready-for-service.js should pass ESLint\n\n');
  });

  QUnit.test('routes/submarine-cable.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/submarine-cable.js should pass ESLint\n\n');
  });
});
define('cablemap-gis/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('cablemap-gis/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'cablemap-gis/templates/application.hbs should pass TemplateLint.\n\ncablemap-gis/templates/application.hbs\n  13:6  error  elements cannot have inline styles  no-inline-styles\n');
  });

  QUnit.test('cablemap-gis/templates/components/company-logos.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'cablemap-gis/templates/components/company-logos.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('cablemap-gis/templates/components/copyright-year.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'cablemap-gis/templates/components/copyright-year.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('cablemap-gis/templates/components/link-to-landing-point.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'cablemap-gis/templates/components/link-to-landing-point.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('cablemap-gis/templates/components/map-container.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'cablemap-gis/templates/components/map-container.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('cablemap-gis/templates/country.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'cablemap-gis/templates/country.hbs should pass TemplateLint.\n\ncablemap-gis/templates/country.hbs\n  3:22  error  elements cannot have inline styles  no-inline-styles\n');
  });

  QUnit.test('cablemap-gis/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'cablemap-gis/templates/index.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('cablemap-gis/templates/landing-point.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'cablemap-gis/templates/landing-point.hbs should pass TemplateLint.\n\ncablemap-gis/templates/landing-point.hbs\n  3:22  error  elements cannot have inline styles  no-inline-styles\n');
  });

  QUnit.test('cablemap-gis/templates/ready-for-service.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'cablemap-gis/templates/ready-for-service.hbs should pass TemplateLint.\n\ncablemap-gis/templates/ready-for-service.hbs\n  3:22  error  elements cannot have inline styles  no-inline-styles\n');
  });

  QUnit.test('cablemap-gis/templates/submarine-cable.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'cablemap-gis/templates/submarine-cable.hbs should pass TemplateLint.\n\ncablemap-gis/templates/submarine-cable.hbs\n  5:22  error  elements cannot have inline styles  no-inline-styles\n');
  });
});
define('cablemap-gis/tests/lint/tests.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('unit/routes/landing-point-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/landing-point-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/ready-for-service-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/ready-for-service-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/submarine-cable-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/submarine-cable-test.js should pass ESLint\n\n');
  });
});
...
define('cablemap-gis/tests/unit/routes/country-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | country', function (hooks) {
...
define('cablemap-gis/tests/unit/routes/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('cablemap-gis/tests/unit/routes/landing-point-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | landing-point', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('cablemap-gis/tests/unit/routes/ready-for-service-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | ready-for-service', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('cablemap-gis/tests/unit/routes/submarine-cable-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | submarine-cable', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
require('cablemap-gis/tests/test-helper');
